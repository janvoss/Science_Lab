...
:-------------------------:|:-------------------------:
![](logo.png)  |  ![https://janvoss.github.io/Science_Lab](qr.svg){width=40% }
...
**Chancen und Risiken von Künstlicher Intelligenz für die deutsche Wirtschaft**. Als Prüfungsleistungen schreiben Sie
in Dreierteams (zur Not: allein) eine kurze **wissenschaftliche
Ausarbeitung** und absolvieren Sie eine **mündliche Prüfung**. Die Ergebnisse ihrer Ausarbeitungen werden wir am Ende (vielleicht) in einem **Plakat** zusammenfassen

Grundlage Ihrer Seminararbeit sind die Beiträge aus dem Zeitgespräch in
der Zeitschrift [Wirtschaftsdienst](https://www.wirtschaftsdienst.eu/inhalt/jahr/2023/heft/8/beitrag/chancen-und-risiken-von-kuenstlicher-intelligenz-fuer-die-deutsche-wirtschaft.html)
zum oben genannten Thema:
@bertschek_jetzt_2023,
@bruhl_kunstliche_2023, 
@engels_kunstliche_2023 und 
@vopel_unmenschliche_2023.
...
Abgabe aller Unterlagen bis zum *26. Juni 2024*  bitte in elektronischer Form im Portable Document Format (pdf) über den **Uploadordner für Seminararbeiten** in neo. *Bitte benennen Sie unbedingt Ihre Datei in dem Format &bdquo;Nachname.pdf&ldquo;.*
...
- Beispiele: Chat GPT, Microsoft Bing Chat, Google  Gemini, Monica, Perplexity, $\dots$
