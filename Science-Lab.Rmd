...
date: "HfWU Zukunftsökonomie | SoSe 2025"
...
**Neuwahlen in Deutschland: Empfehlungen an die neue Bundesregierung**. Als Prüfungsleistungen schreiben Sie
...
der Zeitschrift [Wirtschaftsdienst](https://www.wirtschaftsdienst.eu/inhalt/jahr/2025/heft/1/beitrag/neuwahlen-in-deutschland-empfehlungen-an-die-neue-bundesregierung.html)
zum oben genannten Thema:

[Anpassen]::

@dullien_mit_2025,
@grimm_wachstumsagenda_2025,
@gros_drei_2025,
@holtemoller_wachstumsschwache_2025, 
@krebs_fair_2025,
@schmidt_gegen_2025,
@schuster-johnson_von_2025 und
@wambach_europa_2025
...
Abgabe aller Unterlagen bis zum *25. Juni 2025*  bitte in elektronischer Form im Portable Document Format (pdf) über den **Uploadordner für Seminararbeiten** in neo. *Bitte benennen Sie unbedingt Ihre Datei in dem Format &bdquo;Nachname.pdf&ldquo;.*
...
### KI-gestützte Dienste als Recherche*ersatz* oder Inhaltlicher Antwortgeber
...
- Einige Dienste erlauben auch die Echtzeitsuche im Internet

- Dies kann eine Hilfe bei der Recherche bieten

- Allerdings haben die Dienste keinen umfassenden Zugriff auf wissenschaftliche Literatur 
...
- Derartiges Wissen besteht nicht zwingend nur aus wahren Aussagen (Irrtum kann immer noch entdeckt werden)
...
- Wissenschaft ist nach BVerfG, „was nach Inhalt und Form als ernsthafter und planmäßiger Versuch zur Ermittlung von Wahrheit anzusehen ist“ (zitiert nach @garditz_politische_nodate)
...
# Thematische Sammlung: Welche Dimensionen haben Chancen und Risiken der KI

## Chancen

- Chance auf Fehlerfreiheit

- Arbeitsplätze können ersetzt werden: Produktivität der Beschäftigten steigt

- Höhere Effizienz (evtl. höhere Effektivität)

- Automatisierte Erkennung von Gefahren (iwS) im öffentlichen Raum, social media, usw. 

## Risiken

- Arbeitsplätze können ersetzt werden

- Verselbständigung von KI-Systemen
...
- Akzeptanz in der Gesellschaft  
  ...
  - Kann man solchen Systemen noch ausweichen
  
  - Akzeptanz in unterschiedlichen Alterskohorten
  
  - Einfluss auf die Meinungsbildung
  
- Unternehmen: Investitionen (mit unsicherem Erfolg)
